# Zephyr MicroPython port for K64F

See also [MicroPython official docs](https://docs.micropython.org/en/latest/zephyr/quickref.html)
for reference!
...
## Flash access
To access internal Flash(=1MB) in the Kinetis K64F on FRDM-K64F:
```python
import os
...
## Sensor access
To access FXO8700 accelerometer on FRDM-K64F:
```python
import zsensor
...
```
NOTE: the sensor-name "FXOX8700" is taken from FRDM-K64F DeviceTree-configuration!
